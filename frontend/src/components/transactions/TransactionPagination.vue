  ...
  <div class="flex flex-col sm:flex-row items-center justify-between py-8 gap-4">
    <div class="flex items-center gap-4">
      ...
      <p class="text-sm font-medium text-muted-foreground">
        Page <span class="text-foreground font-bold">{{ currentPage }}</span> of
    ...
    <div class="flex items-center gap-6">
      <div class="flex items-center gap-2">
        <span class="text-xs font-bold text-muted-foreground uppercase tracking-widest">Show</span>
        <DropdownMenu>
      ...
      <p class="text-xs font-bold text-muted-foreground uppercase tracking-widest">
        Total <span class="text-foreground">{{ totalItems }}</span> items
      </p>
    </div>
  </div>
</template>
